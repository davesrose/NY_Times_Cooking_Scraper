...
request(page, function(error, response, html) {
    ...
    let author = $('a .byline-name').text();
    let notes = [];
    $('section .recipe-notes li .recipe-note-description').each(function(i, element) {
